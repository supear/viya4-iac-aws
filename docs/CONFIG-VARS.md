...
| <a name="vm_public_access_cidrs">vm_public_access_cidrs | IP Ranges allowed to access the VMs | list of strings | | opens port 22 for SSH access to the jump and/or nfs VM |
| <a name="postgres_public_access_cidrs">postgres_public_access_cidrs</a> | IP Ranges allowed to access the AWS PostgreSQL Server | list of strings |||
